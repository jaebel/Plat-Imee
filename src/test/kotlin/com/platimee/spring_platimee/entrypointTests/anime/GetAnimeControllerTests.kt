...
class GetAnimeControllerTests(
    ...
    test("Can retrieve all anime") {
        val testAnime1 = AnimeCreateDTO(name = "Naruto", type = AnimeType.TV, episodes = 220, rating = 8.5, members = 1000000, genres = listOf(1, 2))
        val testAnime2 = AnimeCreateDTO(name = "Sousou no Frieren", type = AnimeType.TV, episodes = 28, rating = 8.5, members = 1000000, genres = listOf(1, 2))
    ...
    test("Can retrieve a anime by ID") {
        val testAnime = AnimeCreateDTO(name = "Naruto", type = AnimeType.TV, episodes = 220, rating = 8.5, members = 1000000, genres = listOf(1, 2))
        ...
        fetchedAnime.rating shouldBe 8.5
        fetchedAnime.members shouldBe 1000000
